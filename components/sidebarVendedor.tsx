...
export default function SidebarVendedor({ onClose }: { onClose: () => void }) {
  ...
  const userPhoto =
    profile?.photoURL ||
    "https://ui-avatars.com/api/?name=Usuario&background=6C63FF&color=fff&size=128";
      ...
      <ScrollView>
        ...
        <View style={styles.userInfo}>
          ...
          <View style={styles.roleContainer}>
            ...
            <Ionicons name="checkmark-circle" size={16} color="#2ecc71" style={styles.roleIcon} />
          </View>
